...
/* main.js */
function imageSlide(e,t){function n(){s||(s=setTimeout(function(){s=null,l.style.position="relative",l.style.left=(window.innerWidth-m[0].clientWidth)/2+"px",a(0),v=Flipsnap(l,{distance:m[0].clientWidth,maxPoint:f,duration:d}),v.moveToPoint(c,0),v.element.addEventListener("fspointmove",i),Array.prototype.slice.call(u).forEach(function(e,t){e.addEventListener("click",function(e){console.log(t+c),v.moveToPoint(t+c)},!1)})},66))}function i(e){v.currentPoint>v.maxPoint-1?o(!0):v.currentPoint<c?o():a(v.currentPoint-c)}function o(e){var t,n;e?(t=v.maxPoint,n=c):(t=1,n=v.maxPoint-1),v.element.removeEventListener("fspointmove",i),v.moveToPoint(t),timer=setTimeout(function(){v.moveToPoint(n,0),a(n-c),v.element.addEventListener("fspointmove",i),clearTimeout(timer)},d+3)}function r(e,t){var n=document.createDocumentFragment(),i=e.length;return _.range(i+2*t).forEach(function(t,o){var r=(o%i+1)%i;n.appendChild(e[r].cloneNode(!0))}),n}function a(e){Array.prototype.slice.call(u).forEach(function(t,n){n!==e||t.className.match("isActive")?n!==e&&t.className.match("isActive")&&(t.className=t.className.replace(" isActive","")):t.className+=" isActive"})}var s=null,c=t.extra||2,l=document.getElementById(e),m=document.getElementsByClassName(t.itemClassName||"js-slide-item"),u=document.getElementsByClassName(t.pointClassName||"js-slide-point"),d=t.duration||350,f=m.length+c,v=null;if(l&&m&&u){if(m.length<2)return m[0].style.margin="0 auto",void Array.prototype.slice.call(u).map(function(e,t){e.style.display="none"});var p=r(m,c);l.innerHTML="",l.appendChild(p),n(),window.addEventListener("resize",n,!1)}}var timer=null,winH=window.innerHeight;jQuery(window).on("resize",function(){clearTimeout(timer),timer=setTimeout(function(){var e=window.innerHeight,t=e-winH,n=parseInt(jQuery(".footer").css("min-height")),i=parseInt(jQuery(".footer").css("max-height"));if(t>0){t<=n?t=n:t>=i&&(t=i),jQuery(".footer").css("height",t);var o=e-t;jQuery(".footer").addClass("footer_act"),jQuery(".footer2").css("height",t)}else{var o=e;jQuery(".footer").removeClass("footer_act"),jQuery(".footer2").css("height",0)}jQuery(".wrapper").css("height",o),winH=e},600)}),function(){function e(e,t,n){var i=" "+t;return function(n){e.className.indexOf(t)>-1?e.className=e.className.replace(i,""):e.className+=i}}var t=document.getElementById("menu-button"),n=document.getElementById("wrapper"),i=document.getElementById("overlay"),o=e(n,"isOpened");t&&i&&(t.addEventListener("click",o,!1),i.addEventListener("click",o,!1))}();